...
# ── CORS ─────────────────────────────────────────────────────────────────────
_default_origins = 'http://localhost:8080,http://127.0.0.1:8080,http://localhost:8888,http://127.0.0.1:8888,https://smoker.example.com'
...
def _local_ipv4_addrs() -> list[str]:
    ...
    try:
        ...
        try:
            s.connect(('192.0.2.1', 80))  # RFC5737 TEST-NET-1; UDP connect sends no packets
