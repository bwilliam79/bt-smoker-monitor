...
| **Public login** | Username and password for `https://smoker.example.com`. Editable on kitchen LAN only (`http://203.0.113.23:8888`). Eight or more characters. Hashed in `/data/config.json`. Never returned by the API. |
